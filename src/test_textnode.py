...
class TestTextNode(unittest.TestCase):
    ...
    def test_eq_url(self):
        node = TextNode("This is a text node", text_type_italic, "https://www.https://example.com/")
        node2 = TextNode("This is a text node", text_type_italic, "https://www.https://example.com/")
        self.assertEqual(node, node2)
